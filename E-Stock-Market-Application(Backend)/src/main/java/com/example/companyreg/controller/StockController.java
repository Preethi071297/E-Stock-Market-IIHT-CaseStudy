...
public class StockController {
	...
	public List<Stock> getStockByCodeWithStartAndEndDate(@PathVariable String companyCode ,@PathVariable String startDate ,@PathVariable String endDate) throws ParseException {
